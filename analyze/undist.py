...
def main():
    parser = argparse.ArgumentParser(description="Undistort images using calibration data.")
    parser.add_argument("source_dir", help="Directory containing images to undistort")
    ...
    dest_dir = source_dir.parent / f"{source_dir.name}_undist"

    # Load calibration results
    calib_data = np.load(args.calib, allow_pickle=True)
